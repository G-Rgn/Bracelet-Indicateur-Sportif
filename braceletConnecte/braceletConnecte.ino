...
void getHeartRate(NimBLEClient* pClient){
  ...
  uint8_t notificationOn[] = {0xfc, 0x09, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, (byte)((~(252+9+2)+1)&0xff)};
...
void alarm(NimBLEClient* pClient){
  ...
  uint8_t notificationOn[] = {0xfc, 0x10, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, (byte)((~(252+16+1)+1)&0xff)}; //alert
...
void luminosite(NimBLEClient* pClient, uint8_t value){
  ...
  const uint8_t notificationOn[] = { 0xfc, 0x0f, 0x04, (byte)value, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, (byte)((~(252+15+4+value)+1)&0xff)}; //luminosité (0x00/0x01/0x02/) trouvé dans bleCmd
...
void reveil(NimBLEClient* pClient, uint8_t heure, uint8_t minute){
  ...
  const uint8_t notificationOn[] = {0xfc, 0x01, 0x00, 0x01, 0x02, 0x02, 0x00, 0x00, (byte)heure, (byte)minute, 0x08, 0x30, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, (byte)((~(252+1+1+2+2+heure+minute)+1)&0xff)}; //réveil
