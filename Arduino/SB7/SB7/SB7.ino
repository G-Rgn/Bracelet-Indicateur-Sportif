...
class AdvertisedDeviceCallbacks: public NimBLEAdvertisedDeviceCallbacks {
    ...
    void onResult(NimBLEAdvertisedDevice* advertisedDevice) {
      ...
      if (advertisedDevice->getName() == "SB 7+")
      {
...
void getHeartRate(NimBLEClient* pClient){
  ...
  NimBLERemoteCharacteristic* chrHeartRead = nullptr;
  ...
  chrHeartRead = serviceHeart->getCharacteristic(NimBLEUUID("00002d00-0000-1000-8000-00805f9b34fb"));
